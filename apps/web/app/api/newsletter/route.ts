...
<div style="max-width:560px;margin:0 auto;background:#fff;border-radius:18px;padding:36px 32px;box-shadow:0 4px 20px rgba(14,27,58,.07)">
  <p style="margin:0 0 12px;color:#3FB8D4;font-size:13px;letter-spacing:.14em;text-transform:uppercase;font-weight:700">— Welcome aboard</p>
  ...
  <p style="margin:0 0 28px;line-height:1.7">In the meantime, dive into our most recent <a href="https://vsolutionsinc.com/case-study/" style="color:#C9A961;font-weight:600">case studies</a> or browse the <a href="https://vsolutionsinc.com/blog-insights/" style="color:#C9A961;font-weight:600">blog</a>.</p>
  <a href="https://vsolutionsinc.com/" style="display:inline-block;padding:12px 22px;background:linear-gradient(135deg,#3FB8D4,#C9A961);color:#fff;text-decoration:none;border-radius:10px;font-weight:600;font-size:14px;letter-spacing:.01em;box-shadow:0 8px 24px -8px rgba(63,184,212,.4)">Visit vsolutionsinc.com →</a>
...
function adminNotifyEmail(email: string, name: string | null, source: string | null, ip: string | null) {
  return {
    ...
    html: `<!doctype html><html><body style="font-family:system-ui,-apple-system,sans-serif;background:#F4F8FF;padding:24px;color:#0E1B3A;margin:0">
<div style="max-width:560px;margin:0 auto;background:#fff;border-radius:16px;padding:30px;box-shadow:0 4px 16px rgba(14,27,58,.06)">
  <p style="margin:0 0 8px;color:#C9A961;font-size:13px;letter-spacing:.14em;text-transform:uppercase;font-weight:700">— New subscriber</p>
  <h1 style="margin:0 0 22px;font-size:20px;color:#0E2C66">${escapeHtml(email)} just subscribed</h1>
  <table style="width:100%;border-collapse:collapse;font-size:14px;line-height:1.6">
    <tr><td style="padding:6px 0;width:90px;color:#64748B">Email</td><td><a href="mailto:${escapeHtml(email)}" style="color:#3FB8D4">${escapeHtml(email)}</a></td></tr>
